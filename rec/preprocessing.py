...
def _create_instance(reviews_file, meta_file):
    ...
    for line in f_reviews:
        ...
        # user_dict: {'ADZPIG9QOCDG5': [('ADZPIG9QOCDG5\t0005019281\t1203984000', 1203984000.0)]}
...
def _data_processing(input_file):
    ...
    output_file = os.path.join(dirs,"preprocessed_output.txt")
